...
const boatClassInput = document.getElementById("inputClass");
const boatNumberInput = document.getElementById("inputBoatNumber");
const boatNameInput = document.getElementById("inputBoatName");
const boatTimeInput = document.getElementById("inputTime");
...
function msToFormattedTime(time) {
    let output = "";
