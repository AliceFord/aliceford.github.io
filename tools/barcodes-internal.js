...
function eqrcode(code) {
    ...
    bitstring = "00100000010110110000101101111000110100010111001011011100010011010100001101000000111011000001000111101100000100011110110000010001";
    ...
    for (let i = 0; i < 12; i++) {
        modules[s][s-i] = bitstring[pos++];
        modules[s-1][s-i] = bitstring[pos++];
    }

    for (let i = 0; i < 12; i++) {
        modules[s-2][s-(11-i)] = bitstring[pos++];
        modules[s-3][s-(11-i)] = bitstring[pos++];
    }

    for (let i = 0; i < 12; i++) {
        modules[s-4][s-i] = bitstring[pos++];
        modules[s-5][s-i] = bitstring[pos++];
    }

    for (let i = 0; i < 12; i++) {
        modules[s-6][s-(11-i)] = bitstring[pos++];
        modules[s-7][s-(11-i)] = bitstring[pos++];
    }
    
    for (let i = 0; i < 14; i++) {
        modules[s-8][s-i] = bitstring[pos++];
        modules[s-9][s-i] = bitstring[pos++];
    }
    for (let i = 5; i >= 0; i--) {
        modules[s-8][i] = bitstring[pos++];
        modules[s-9][i] = bitstring[pos++];
    }

    for (let i = 0; i < 6; i++) {
        modules[s-10][i] = bitstring[pos++];
        modules[s-11][i] = bitstring[pos++];
    }
    for (let i = 0; i < 14; i++) {
        modules[s-10][s-(13-i)] = bitstring[pos++];
        modules[s-11][s-(13-i)] = bitstring[pos++];
    }

    for (let i = 0; i < 4; i++) {
        modules[8][s-i-8] = bitstring[pos++];
        modules[7][s-i-8] = bitstring[pos++];
    }

    for (let i = 0; i < 4; i++) {
        modules[5][i+8] = bitstring[pos++];
        modules[4][i+8] = bitstring[pos++];
    }

    for (let i = 0; i < 4; i++) {
        modules[3][s-i-8] = bitstring[pos++];
        modules[2][s-i-8] = bitstring[pos++];
    }

    for (let i = 0; i < 4; i++) {
        modules[1][i+8] = bitstring[pos++];
        modules[0][i+8] = bitstring[pos++];
    }
